...
// Umbral para considerar el texto como largo
...
const SplitText: React.FC<SplitTextProps> = ({
	...
	duration = 0.6,
	ease = 'power3.out',
	splitType = text.length > LONG_TEXT_THRESHOLD ? 'words' : 'chars',
	from = { opacity: 0, y: 40 },
	to = { opacity: 1, y: 0 },
	threshold = 0.1,
	rootMargin = '-100px',
...
// Memoización para evitar renders innecesarios si el texto y props no cambian
